...
class Model {
public:
    // ── Carga el modelo. Solo necesita el heap de SRVs, no DX12Manager completo ──
    void Load(ID3D12Device*              device,
              ID3D12GraphicsCommandList* cmdList,
              ID3D12DescriptorHeap*      srvHeap,   // ← desacoplado de DX12Manager
...
private:
                                    ...
                                    std::map<unsigned int, int> const& matMap)
    {
        ...
        const int texIdx = matMap.count(aiMesh->mMaterialIndex)
